...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BASE] = LAYOUT(
		...
		KC_LCTL , KC_LGUI , KC_LALT ,MO(_LOWER),KC_ENT  , KC_SPC  , KC_MUTE , KC_ENT  , KC_RSFT ,MO(_RAISE),KC_RALT , KC_RGUI , KC_RCTRL
	),
	[_RAISE] = LAYOUT(
	...
	[_LOWER] = LAYOUT(
		...
		KC_NO	, KC_MINS , KC_EQL  , KC_LBRC , KC_RBRC , KC_BSLS           , KC_NO   , KC_NO , KC_NO ,  KC_NO  , KC_NO , KC_BSLS ,
